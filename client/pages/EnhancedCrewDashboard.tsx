...
import CrewStatusToggle, {
  type CrewStatus,
} from "@/components/CrewStatusToggle";
import {
  Calendar,
  Clock,
  MapPin,
...
export default function EnhancedCrewDashboard() {
  ...
  const startLocationTracking = () => {
    ...
    if (!isGeolocationSupported()) {
      ...
      toast({
        ...
        description:
          "Location tracking is not supported on this device. GPS features will be disabled.",
        variant: "destructive",
      });
      return;
    }
    ...
    const handleLocationError = (error: GeolocationPositionError) => {
      ...
      if (error.code === 3) {
        ...
        console.log(
          `📍 Location timeout (attempt ${timeoutCount}, fallback: ${isUsingFallback})`,
        );
        ...
        if (timeoutCount === 1) {
          toast({
            ...
            description:
              "GPS is taking longer than usual. Trying different accuracy settings...",
            duration: 4000,
          });
          ...
          toast({
            ...
            description:
              "Having trouble getting precise location. Try moving near a window or outdoors.",
            variant: "destructive",
            duration: 6000,
          });
        }
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        const errorDetails = getGeolocationErrorDetails(error);
        console.warn(
          "Initial location fetch failed, starting watch anyway:",
  ...
  const updateBookingStatus = async (
    ...
    try {
      ...
      const updatedBooking = {
        ...
        ...(status === "crew_arrived" && {
          crewArrivalTime: new Date().toISOString(),
        }),
        ...(status === "washing" && {
          crewStartTime: new Date().toISOString(),
        }),
        ...(status === "completed" && {
          crewCompletionTime: new Date().toISOString(),
        }),
      };
  ...
  const acceptAssignment = async (assignmentId: string) => {
    try {
      ...
      updateCrewAssignmentStatus(
        assignmentId,
        "accepted",
        "Assignment accepted by crew member",
      );
  ...
  const rejectAssignment = async (assignmentId: string) => {
    try {
      updateCrewAssignmentStatus(
        assignmentId,
        "rejected",
        "Assignment rejected by crew member",
      );
  ...
  const saveSignature = () => {
    ...
    const signatureData: SignatureData = {
      ...
      customerName:
        selectedBooking.guestInfo?.firstName +
          " " +
          selectedBooking.guestInfo?.lastName || "Customer",
      signatureDataUrl,
    ...
    const signatures = JSON.parse(
      localStorage.getItem("customer_signatures") || "[]",
    );
  ...
  const stats = {
    ...
    pendingAssignments: assignments.filter((a) => a.status === "assigned")
      .length,
    acceptedAssignments: assignments.filter((a) => a.status === "accepted")
      .length,
    completedBookings: bookings.filter((b) => b.status === "completed").length,
    rating: currentUser?.crewRating || 0,
    activeJobs: bookings.filter((b) =>
      ["crew_going", "crew_arrived", "in_progress", "washing"].includes(
        b.status,
      ),
    ).length,
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto p-6 space-y-6">
                ...
                <div className="flex flex-wrap items-center gap-4 text-gray-600">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      className={cn(
                        "font-medium",
                        currentUser?.crewStatus === "online" ||
                          currentUser?.crewStatus === "busy"
                  ...
                  onClick={async () => {
                    try {
                      toast({
                        ...
                        description:
                          "Running timeout-resistant location acquisition...",
                        duration: 2000,
                      });
                      ...
                      if (location) {
                        ...
                        toast({
                          ...
                          description:
                            "All GPS methods failed. Check device settings.",
                          variant: "destructive",
                          duration: 5000,
                        });
                      }
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <Card
            className={`bg-gradient-to-br border-2 hover:shadow-lg transition-all duration-300 ${
              isTrackingLocation
              ...
              {assignments
                ...
                .map((assignment) => {
                  ...
                  return (
                    <Card
                      key={assignment.id}
                      className="hover:shadow-xl transition-all duration-300 border-l-4 border-l-fac-orange-500 bg-gradient-to-r from-orange-50 to-white"
                    >
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                              <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="font-semibold text-fac-orange-600">
                                      {booking.service}
                                    </p>
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="font-bold text-xl text-fac-orange-600">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="grid md:grid-cols-3 gap-4 flex-1">
                            ...
                            <div>
                              <p className="font-medium text-fac-orange-500">
                                {booking.service}
                              </p>
                              <p className="text-sm text-muted-foreground flex items-center">
                            ...
                            <div>
                              <p className="font-semibold text-lg text-fac-orange-500">
                                ₱{booking.totalPrice.toLocaleString()}
                              </p>
                          ...
                          <div className="grid grid-cols-2 gap-2 ml-4">
                                ...
                                <div className="space-y-4">
                                  <div className="text-center">
                                    <p className="text-sm text-muted-foreground mb-4">
                                      Ask the customer to sign below to confirm
                                      service completion
                                    </p>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const phoneNumber =
                                  booking.guestInfo?.phone || "customer";
                        ...
                        {booking.crewNotes && (
                          <div className="p-3 bg-muted rounded-lg">
                            <p className="text-sm">
                              <strong>Crew Notes:</strong> {booking.crewNotes}
                            </p>
                          </div>
                        )}
                      </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2">
                <CrewStatusToggle
                  ...
                  initialStatus={
                    (currentUser?.crewStatus as CrewStatus) || "offline"
                  }
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-3">
                      ...
                      <div className="rounded-lg border p-4">
                        ...
                        <p className="text-2xl font-semibold">
                          ₱
                          {Number(payrollSummary.totalCommission || 0).toFixed(
                            2,
                          )}
                        </p>
                      </div>
                    ...
                    <div className="rounded-lg border p-4">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {new Date(
                          payrollSummary.period.startDate,
                        ).toLocaleDateString()}{" "}
                        -{" "}
                        {new Date(
                          payrollSummary.period.endDate,
                        ).toLocaleDateString()}{" "}
                        (Paid on{" "}
                        {new Date(
                          payrollSummary.period.payoutDate,
                        ).toLocaleDateString()}
                        )
                      </p>
                    </div>
