            ...
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 dark:from-blue-950 dark:to-blue-900 dark:border-blue-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-blue-700 dark:text-blue-300">Total Crew</p>
                    <p className="text-xl font-bold text-blue-900 dark:text-blue-100">20</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 dark:from-green-950 dark:to-green-900 dark:border-green-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-green-700 dark:text-green-300">Online Crew</p>
                    <p className="text-xl font-bold text-green-900 dark:text-green-100">18</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200 dark:from-orange-950 dark:to-orange-900 dark:border-orange-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-orange-700 dark:text-orange-300">Busy Crew</p>
                    <p className="text-xl font-bold text-orange-900 dark:text-orange-100">12</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 dark:from-purple-950 dark:to-purple-900 dark:border-purple-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-purple-700 dark:text-purple-300">Customers</p>
                    <p className="text-xl font-bold text-purple-900 dark:text-purple-100">50</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-indigo-50 to-indigo-100 border-indigo-200 dark:from-indigo-950 dark:to-indigo-900 dark:border-indigo-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-indigo-700 dark:text-indigo-300">Active</p>
                    <p className="text-xl font-bold text-indigo-900 dark:text-indigo-100">47</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xl font-bold text-emerald-900 dark:text-emerald-100">8</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-yellow-200 dark:from-yellow-950 dark:to-yellow-900 dark:border-yellow-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-yellow-700 dark:text-yellow-300">Champions</p>
                    <p className="text-xl font-bold text-yellow-900 dark:text-yellow-100">5</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-red-50 to-red-100 border-red-200 dark:from-red-950 dark:to-red-900 dark:border-red-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-red-700 dark:text-red-300">VIP</p>
                    <p className="text-xl font-bold text-red-900 dark:text-red-100">12</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 dark:from-purple-950 dark:to-purple-900 dark:border-purple-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-purple-700 dark:text-purple-300">Loyal</p>
                    <p className="text-xl font-bold text-purple-900 dark:text-purple-100">18</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 dark:from-blue-950 dark:to-blue-900 dark:border-blue-800">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-blue-700 dark:text-blue-300">Regular</p>
                    <p className="text-xl font-bold text-blue-900 dark:text-blue-100">10</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200 dark:from-gray-800 dark:to-gray-900 dark:border-gray-700">
              <CardContent className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-xs font-semibold text-gray-700 dark:text-gray-300">New</p>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-2 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      ...
                      <Badge className="bg-orange-500 text-white">12 Crew</Badge>
                    </div>
                    <div className="flex items-center justify-between p-2 bg-purple-50 dark:bg-purple-950 rounded-lg">
                      ...
                      <Badge className="bg-purple-500 text-white">47 Active</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500">Status: Online • 2min ago</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500">Status: Busy • 5min ago</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500">VIP • Active • 8min ago</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
