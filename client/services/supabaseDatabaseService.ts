...
class SupabaseDatabaseClient {
  ...
  async getCommissionRates(): Promise<{
    ...
    try {
      const response = await fetch(
        `${this.baseUrl}/crew/commission-rates`,
        {
          signal: ac.signal,
        },
      );
  ...
  async createCommissionEntry(payload: {
    ...
    try {
      const response = await fetch(
        `${this.baseUrl}/crew/commission-entries`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  async updateInventoryItem(
    ...
    try {
      ...
      const response = await fetch(
        `${this.baseUrl}/inventory/items/${id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(updates),
  ...
  async createStockMovement(movementData: {
    ...
    try {
      ...
      const response = await fetch(
        `${this.baseUrl}/inventory/movements`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
